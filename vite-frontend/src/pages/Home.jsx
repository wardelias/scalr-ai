...
export default function Home() {
  ...
  useEffect(() => {
    // Re-initialize intersection observer for new page mounts
      ...
      <section className="final-cta">
        <div className="container text-center fade-up">
          ...
          <div className="cta-form glass-panel">
            <a href="#" className="btn-primary btn-large btn-block" onClick={(e) => { e.preventDefault(); alert('Calendly/Cal.com embed placeholder'); }}>
              <span>{t('btn_book_your')}</span> <span>{t('demo_dir_arrow')}</span>
            </a>
            <div className="cta-alt">
              <span>{t('cta_al')}</span> <a href="#" className="accent-text" dir="ltr">+972-50-000-0000</a>
            </div>
          </div>
        </div>
      </section>
